...
j = surface([x_min, x_min; x_min, x_min], ...    %maps all corners of the fence with its respected x,y,z
        [y_min, y_max; y_min, y_max], ...
        [z_min, z_min; z_max, z_max], ...
        'CData', Bar, 'FaceColor', 'texturemap');   %Takes data of fence for colour and surface and use as texture map

direction = [1 0 0];
rotate(j,direction,180)
   ...
   %Fire Extinguisher
    ...
    transformedVertices = [vertices,ones(size(vertices,1),1)] * transl(0.1,1.5,-2.49)' * trotx(pi/2)';
    set(mesh_h,'Vertices',transformedVertices(:,1:3));
